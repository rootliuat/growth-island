...
export const moduleConfigs: ModuleConfig[] = [
  ...
  },
  {
    ...
    futureItems: ["奖池配置", "中奖记录", "活动积分", "抽奖后回到成长岛展示"],
  ...
  },
  {
    ...
    futureItems: ["真实库存", "兑换审批", "奖品维护", "可消费积分与成长 XP 拆分"],
  ...
  },
  {
    ...
    futureItems: ["搜索筛选", "真实导出", "批量导入", "复核记录详情", "数据同步诊断"],
  ...
  },
  {
    ...
    futureItems: ["真实保存", "规则编辑", "奖品设置", "权限配置", "主题配置"],
