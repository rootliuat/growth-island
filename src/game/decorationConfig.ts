...
export const decorations: DecorationItem[] = [
  ...
  { id: "mg-07", kind: "tree", regionId: "mangrove", position: { x: 315, y: 462 }, scale: 0.82 },
  { id: "mg-08", kind: "flower", regionId: "mangrove", position: { x: 825, y: 760 }, scale: 0.72 },
  { id: "mg-09", kind: "rock", regionId: "mangrove", position: { x: 930, y: 710 }, scale: 0.64 },
  ...
  { id: "sh-07", kind: "lamp", regionId: "shell-bay", position: { x: 545, y: 1126 }, scale: 0.72 },
  { id: "sh-08", kind: "scallop", regionId: "shell-bay", position: { x: 668, y: 1258 }, scale: 0.68 },
  { id: "sh-09", kind: "flag", regionId: "shell-bay", position: { x: 362, y: 1148 }, scale: 0.72 },
  ...
  { id: "pb-06", kind: "pearl", regionId: "pearl-bay", position: { x: 1530, y: 548 }, scale: 0.72 },
  { id: "pb-07", kind: "shell", regionId: "pearl-bay", position: { x: 2042, y: 654 }, scale: 0.58 },
  { id: "pb-08", kind: "lamp", regionId: "pearl-bay", position: { x: 1872, y: 735 }, scale: 0.7 },
  ...
  { id: "st-07", kind: "flower", regionId: "sun-town", position: { x: 1988, y: 1170 }, scale: 0.8 },
  { id: "st-08", kind: "mailbox", regionId: "sun-town", position: { x: 1530, y: 1002 }, scale: 0.7 },
  { id: "st-09", kind: "sign", regionId: "sun-town", position: { x: 1725, y: 970 }, scale: 0.68 },
  ...
  { id: "os-06", kind: "lamp", regionId: "old-street", position: { x: 930, y: 500 }, scale: 0.76 },
  { id: "os-07", kind: "flower", regionId: "old-street", position: { x: 1260, y: 540 }, scale: 0.62 },
  { id: "os-08", kind: "rock", regionId: "old-street", position: { x: 1465, y: 460 }, scale: 0.58 },
  ...
  { id: "ma-06", kind: "flag", regionId: "math-arena", position: { x: 1150, y: 1045 }, scale: 0.85 },
  { id: "ma-07", kind: "lamp", regionId: "math-arena", position: { x: 1510, y: 1188 }, scale: 0.7 },
  { id: "ma-08", kind: "rock", regionId: "math-arena", position: { x: 945, y: 1220 }, scale: 0.62 },
];
